...
const C1_pregnancyT1: CheckinFlow = {
 ...
 { type:"scale", label:"مستوى الطاقة اليوم؟" },
 { type:"multi", label:"كيف يشعر جسمكِ اليوم؟", options: ["إرهاق","غثيان","ألم صدر","انتفاخ","صداع"," نزّاز خفيف"], alertOptions: [" نزّاز خفيف"] },
...
const C6_csection: CheckinFlow = {
 ...
 { type:"single", label:"كيف هو نزيف النفاس؟", options: ["خفيف","متوسّط","غزير","توقّف"] },
 { type:"single", label:"كيف هو الجرح؟", options: ["يلتئم جيّداً","بعض الانزعاج"," ألم أو قلق"], alertOptions: [" ألم أو قلق"] },
...
const E5_overtraining: CheckinFlow = {
 ...
 steps: [
 { type:"single", label:"كيف يشعر جسمكِ الآن؟", options: ["نشيطة","متوجّعة لكن بخير","متعبة جدّاً"," ألم أو قلق إصابة"], alertOptions: [" ألم أو قلق إصابة"] },
