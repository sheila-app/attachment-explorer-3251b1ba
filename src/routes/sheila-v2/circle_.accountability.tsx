        ...
        {stage === "done" && (
          <div className="mt-5 rounded-2xl bg-white/85 border border-border p-5 text-center">
            ...
            <div className="grid grid-cols-2 gap-2 mt-4">
              ...
              <button className="py-2.5 rounded-xl text-primary-foreground text-[12.5px] font-semibold flex items-center justify-center gap-1.5" style={{ background: "var(--gradient-primary)" }}><Check size={13} /> قبول</button>
            </div>
          </div>
        )}
      </div>
